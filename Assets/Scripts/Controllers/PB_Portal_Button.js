...
if(movement.getPCDebugging()){
		...
		isPressingThis = false;
   		...
   		if(isPressingThis && (Input.GetMouseButtonUp(0)&& guiTexture.HitTest(Input.mousePosition)) && PlayerPrefs.GetInt("PortalRigUnlocked",0) == 1){
   			movement.setRig("PortalRig");
    ...
    var count : int = Input.touchCount;
      ...
      if(movement.getIsInGameMode() &&    PlayerPrefs.GetString("Rig") == "PortalRig"){
    	guiTexture.color = Color.green;
    	guiTexture.color.a = 0.35;
    }else if(PlayerPrefs.GetInt("PortalRigUnlocked",0) == 1){
